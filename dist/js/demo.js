...
console.log('asdasdasdadasdas');
  ...
  /* ChartJS
    ...
    $.get('https://raw.githubusercontent.com/devgrigor/static_files/master/data/aid_received_per_person_current_us.json')
    .then(res => {
      res = JSON.parse(res);
      console.log(res);
    });
    ...
    var data = [{
      ...
      // End Defining data
      var myChart = new Chart(scatterCanvas, {
          type: 'scatter',
          data: {
              datasets: [{
